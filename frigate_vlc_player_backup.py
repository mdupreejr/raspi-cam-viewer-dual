...
class FrigateVLCPlayer:
    ...
    def load_ignored_cameras(self):
        """Load list of cameras to ignore"""
        self.ignored_cameras = set()
    ...
    def load_priorities(self):
        """Load detection priorities from file"""
    ...
    def on_message(self, client, userdata, msg):
        try:
            ...
            # Check if camera is in ignore list
    ...
    def play_camera(self, camera, priority=1):
        """Start VLC to play camera stream"""
        
        # Check if the same camera is already playing
    ...
    def run(self):
        """Main loop to connect to MQTT and process messages"""
